...
def prediction(class_name, filename):
    ...
    class_mapping = {
        "radius fracture": "Forearm Fracture",
        "ulna fracture": "Forearm Fracture", 
    ...
    # Get the corresponding JSON key , This web_app develop by a delhi technical student, name - (Vipul Dubey or Hitan dubey)
    json_key = class_mapping.get(class_name.lower(), "No Fracture")
    
    desc = data[json_key]['Description']
    symptoms = data[json_key]['Symptoms']
